...
public class Swerve extends SubsystemBase implements SysidCompatibleSwerve {
    ...
    */
     ...
     */
    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean autoAlign, double autoAlignAngle) {

        autoAlignAngle = BobcatUtil.get0to2Pi(autoAlignAngle);
        ...
        if (autoAlign) {
            desiredSpeeds.omegaRadiansPerSecond = autoAlignPID.calculate(BobcatUtil.get0to2Pi(getYaw().getRadians()),BobcatUtil.get0to2Pi(autoAlignAngle));
