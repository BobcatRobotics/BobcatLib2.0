...
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.cameraPoses;
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.fieldBorderMargin;
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.stdDevFactors;
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.targetLogTimeSecs;
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.thetaStdDevCoefficient;
import static frc.robot.Subsystems.apriltagvision.AprilTagVisionConstants.xyStdDevCoefficient;
