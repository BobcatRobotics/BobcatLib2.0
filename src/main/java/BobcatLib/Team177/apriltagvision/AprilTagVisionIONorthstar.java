...
import BobcatLib.Team6328.Alert;
...
public class AprilTagVisionIONorthstar implements AprilTagVisionIO {
  ...
  public AprilTagVisionIONorthstar(Supplier<AprilTagLayoutType> aprilTagTypeSupplier, int index) {
    ...
    configTable.getDoubleTopic("fiducial_size_m").publish().set(AprilTagVisionFieldConstants.aprilTagWidth);
    configTable.getIntegerTopic("frame_rate").publish().set(maxFPS);
