...
public class SwerveConstants {
    ...
    public SwerveConstants(
            ReplanningConfig replanningConfig, Rotation2d holoAlignTolerance,
            KinematicsConstants kinematicsConstants, SwerveSpeedLimits speedLimits,
            PIDConfigs pidConfigs, OdometryConstants odometryConstants,
    ...
    public class SpeedLimit {
         ...
         */
        public SpeedLimit(double maxVelocity, double maxAccel, Rotation2d maxAngularVelocity,
    ...
    public class SwerveMotorConfig {
        ...
        public SwerveMotorConfig(double rotKP, double rotKI, double rotKD,
                ...
                boolean supplyCurrentLimitEnable, double supplyCurrentLimit, double supplyCurrentThreshold,
                double supplyTimeThreshold,
                boolean statorCurrentLimitEnable, double statorCurrentLimit, double openLoopRamp,
    ...
    public class PIDConfigs {
        ...
        /**
         * gains taken from sysid should likely need to be devided by 12 to convert from
         * volts to percent
         * 
         ...
         * @param autoAlignConfig rotation gains to use in auto, translation gains will
         *                        not be used and can be set to any number
         */
        public PIDConfigs(
    ...
    public class OdometryConstants {
         ...
         * @param distrustStdDevs       std devs to use when the measurements are
         *                              unreliable
         * @param odometryThrowoutAccel acceleration beyond this value will throw out
         *                              odometry measurements
         * @param odometryDistrustAccel aceceleration beyond this value will use
    ...
    public static class SwerveModuleConfigs {
        ...
        public SwerveModuleConfigs(ModuleConfig frontLeft, ModuleConfig frontRight, ModuleConfig backLeft,
                ModuleConfig backRight) {
