...
package lib.BobcatLib.LimeLight;
...
public class LimelightHelpers {
  ...
  /** Empty Class Limelight Target Barcode */
  public static class LimelightTarget_Barcode {}

  /** Limelight Target Classifier */
  ...
  public static class Results {
    ...
    /**
     * gets raw BotPose3d without frame of reference of either red or blue.
     *
     * @return Pose3d
     */
    ...
    /**
     * gets from wpired frame of refence
     *
     * @return Pose3d
     */
    ...
    /**
     * gets from wpiblue frame of reference
     *
     * @return Pose3d
     */
    ...
    /**
     * gets the bot pose as 2d from wpired frame of reference
     *
     * @return Pose2d
     */
    ...
    /**
     * gets the bot pose as 2d from wpiblue frame of reference
     *
     * @return Pose2d
     */
  ...
  public static class RawFiducial {
     ...
     * @param txnc txnc
     * @param tync tync
     * @param ta area to target
     * @param distToCamera distance to camera
     * @param distToRobot distance to robot
   ...
   * work.
   *
   * @param limelightName name
   * @param cropXMin Crop X Min
   * @param cropXMax Crop X Max
   * @param cropYMin Crop Y Min
   * @param cropYMax Crop Y Max
   */
  ...
  /**
   * Sets Robot Orientation
   *
   * @param limelightName name
   * @param yaw yaw
   * @param yawRate rate
   * @param pitch pitch
   * @param pitchRate pitch rate
   * @param roll roll
   * @param rollRate roll rate
   */
   ...
   *
   * @param limelightName name
   * @param outgoingPythonData python data
   */
  ...
  /**
   * @param tableName json table name
   * @param snapshotName snapshot name?
   * @return boolean
   */
