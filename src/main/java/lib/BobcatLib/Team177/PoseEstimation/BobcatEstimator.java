...
package lib.BobcatLib.Team177.PoseEstimation;
 ...
 *
 * <p>{@link BobcatEstimator#addVisionMeasurement} can be called as infrequently as you want; if you
...
public class BobcatEstimator<T extends WheelPositions<T>> {
   ...
   *     BobcatEstimator#updateWithTime(double,Rotation2d,WheelPositions)} then you must use a
   ...
   * BobcatEstimator#setVisionMeasurementStdDevs(Matrix)} or this method.
   *
   * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
   * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof BobcatEstimator.InterpolationRecord)) {
        return false;
      }
      var record = (BobcatEstimator<?>.InterpolationRecord) obj;
