...
import lib.BobcatLib.Team177.CANdle.BuiltInAnimations;
...
public class BobcatUtil {
  ...
  public static Animation getBuiltInAnimation(BuiltInAnimations animation, int ledCount) {
    switch (animation) {
      ...
      case TwinkleOff:
        return new TwinkleOffAnimation(70, 90, 175, 0, 0.8, ledCount, TwinkleOffPercent.Percent100);
      default:
